function [ posx,negx,posn,negn,alpha,eta ] = BRsolvequadprog( data,solveX,C )
...
sumaleta = (round(alpha+eta).*1000)./1000;
target = alpha(alpha>0 & 0<sumaleta & sumaleta<C);  %��alpha����0��C1<alpha(i)+eta(i)<C1�е�Ԫ����ȡ������һ���µ�����
